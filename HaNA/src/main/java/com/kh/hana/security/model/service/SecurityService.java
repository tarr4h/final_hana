...
public class SecurityService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		// 기존 로직 : 제제 되지 않은 신고내역이 10개 이상인 경우 유저 role 제거하여 제제
...
//		 기존 로직 : 2. 로그인 전 제제내역을 확인하여 제제기간이 지난경우 유저 role을 추가해준다.
//		 user_role을 가지고 있는가?
		...
		if(userRoleCount == 0) {
			...
			if(restrictedCount == 0) {
				...
				log.info("insertUserRole, historyS2Y = {}, {}", insertUserRole, historyS2Y);
			}
		}
