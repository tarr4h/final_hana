...
public class ShopServiceImpl implements ShopService {
	...
	/*
	 * @Override public List<Map<String, Object>> selectHashTagShopList(Map<String,
	 * Object> data) { List<Map<String, Object>> hashTagShopList =
	 * shopDao.selectHashTagShopList(data); log.info("shopList = {}",
	 * hashTagShopList);
	 * 
	 ...
	 * Object> shop : hashTagShopList) { String x = (String) shop.get("LOCATION_X");
	 * String y = (String) shop.get("LOCATION_Y"); log.info("serv shop = {}", shop);
	 * boolean bool = CalculateArea.calculateArea(locationX, locationY, x, y);
	 * log.info("calTest = {}", bool);
	 * 
