	    ...
	    <div class="row">
	        ...
	        <div class="col-md-5 border-right">
	            <div class="p-3 py-5">
	                ...
	                <div class="row mt-2">
	                    <div class="col-md-7"><label class="labels">소모임 아이디</label><input type="text" class="form-control" placeholder="first name" value="${group.groupId}" required readonly></div>
	                </div>
	                <div class="row mt-3">
	                    <div class="col-md-7"><label class="labels">소모임명</label><input type="text" class="form-control" placeholder="headline" value="${group.groupName}" required></div>
	                </div>
	                <div class="row mt-3">
	                ...
	                <div class="row mt-3">
	                    <div class="col-md-7"><label class="labels">프로필 사진</label><input type="file" class="form-control" placeholder="country" value="파일 선택">
